...
- **The Law of Demeter**: A module should not know about the innards of objects it manipulates. Avoid `a.getB().getC().doSomething()`.
- **DTOs**: Classes with public variables and no functions.

## 6. Error Handling
- **Use Exceptions instead of Return Codes**: Keeps logic clean.
- **Don't Return Null**: Forces the caller to check for null every time.
- **Don't Pass Null**: Leads to NullReferenceException.
...
- **The Stepdown Rule**: Code reads like a top-down narrative.
