...
Use PROACTIVELY for event-sourced systems, audit trail requirements, or complex domain modeling with temporal queries.
...
Works well with: `saga-orchestration`, `architecture-patterns`, `event-store-design`
